...
Required research outputs for the pre-implementation research gate include keyword intent, competitor research, product requirements, SEO spec, UX spec, design direction, design review, acceptance tests, `brief.v2.draft.yaml`, and `codex-build-prompt.md`.
